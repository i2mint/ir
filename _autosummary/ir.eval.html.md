...
`ir.select.select()` / [`ir.discover()`](ir.html.md#ir.discover) (`discover(min_score="auto")`
...
([`ir.eval_gen.corpus_signature()`](ir.eval_gen.html.md#ir.eval_gen.corpus_signature)), so a frozen label set pins to the
...
* **Parameters:**
  * **corpus** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – an [`Corpus`](ir.index.html.md#ir.index.Corpus) or a registered corpus *name*.
  ...
  * **\*\*search_kw** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – any other [`ir.retrieve.search()`](ir.retrieve.html.md#ir.retrieve.search) keyword (`filter`,
    `rrf_k`, `rerank`, `bm25`, …).
* **Return type:**
...
class was missing). Generate abstention cases with [`ir.eval_gen`](ir.eval_gen.html.md#module-ir.eval_gen) (its
...
* **Parameters:**
  ...
  * **\*\*search_kw** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – any other [`ir.retrieve.search()`](ir.retrieve.html.md#ir.retrieve.search) keyword.
* **Return type:**
  [`MinScoreCalibration`](#ir.eval.MinScoreCalibration)
* **Returns:**
...
* **Parameters:**
  ...
  * **strategy** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – the [`IndexingStrategy`](ir.strategy.html.md#ir.strategy.IndexingStrategy) to index with
    (default [`WholeText`](ir.strategy.html.md#ir.strategy.WholeText)).
...
* **Parameters:**
  ...
  * **metrics** ([`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str)]) – which `ef` metrics to compute (`ndcg` / `recall` /
    `precision` / `mrr` / `map`).
  * **mode** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str)) – ranking mode passed to [`ir.retrieve.search()`](ir.retrieve.html.md#ir.retrieve.search).
...
([`ir.eval_gen.corpus_signature()`](ir.eval_gen.html.md#ir.eval_gen.corpus_signature)) that pin the labels to a corpus snapshot.
