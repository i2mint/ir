...
| [`make_llm_synthesizer`](#ir.make_llm_synthesizer)(\*[, summarize, prompt, ...])  | An LLM-backed `Synthesizer` ([`Artifact`](ir.base.md#ir.base.Artifact) → synopsis).                       |
...
| [`search`](#ir.search)(corpus, query, \*\*kwargs)                   | Search a [`Corpus`](ir.index.md#ir.index.Corpus) (or a corpus *name*, reopened lazily).                    |
...
| [`retriever_for`](#ir.retriever_for)(name, \*\*search_defaults)            | A [`Retriever`](ir.retrieve.md#ir.retrieve.Retriever) bound to the registered corpus *name*.                  |
...
| [`build_corpus`](#ir.build_corpus)(name, \*\*kwargs)                      | Build (or update) a registered/preset corpus by *name*; returns a [`Corpus`](ir.index.md#ir.index.Corpus). |
...
| [`policy_for`](#ir.policy_for)(name)                                    | The effective [`ir.policy.MaintenancePolicy`](ir.policy.md#ir.policy.MaintenancePolicy) for corpus *name*.  |
...
| [`IndexPlan`](#ir.IndexPlan)([filter_fields, surfaces])              | An [`IndexingStrategy`](ir.strategy.md#ir.strategy.IndexingStrategy)'s output for one artifact. |
...
[`ClaudeTurn`](ir.strategy.md#ir.strategy.ClaudeTurn) strategy indexes the user prompt and the
...
* **Return type:**
  [`CorpusSource`](ir.sources.md#ir.sources.CorpusSource)
...
* **Return type:**
  [`CorpusStore`](ir.store.md#ir.store.CorpusStore)
...
An [`IndexingStrategy`](ir.strategy.md#ir.strategy.IndexingStrategy)’s output for one artifact.
...
* **Return type:**
  [`MaintenancePolicy`](ir.policy.md#ir.policy.MaintenancePolicy)
...
per-kind (see [`ir.base.Record.make_id()`](ir.base.md#ir.base.Record.make_id)). Never derive sibling record
ids from `chunk_index`; use the ledger
([`ir.retrieve.records_for_artifact()`](ir.retrieve.md#ir.retrieve.records_for_artifact)). `n_chunks` is stamped on
...
[`ir.index.build()`](ir.index.md#ir.index.build). On multi-kind strategies it therefore differs
from per-kind counters like `metadata["chunk_index"]` (e.g.
[`Package`](ir.strategy.md#ir.strategy.Package): the `description` surface takes
...
ledger via [`ir.retrieve.records_for_artifact()`](ir.retrieve.md#ir.retrieve.records_for_artifact).
...
[`SearchHit`](ir.base.md#ir.base.SearchHit) — or `None` for a *router-only* node (a
...
an open [`Corpus`](ir.index.md#ir.index.Corpus) to skip that. The returned callable carries
the bound corpus on `.corpus` for introspection.

* **Return type:**
  [`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[`...`](https://docs.python.org/3/builtins/constants.html#Ellipsis), [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`SearchHit`](ir.base.md#ir.base.SearchHit)]]
...
* **Return type:**
  [`Corpus`](ir.index.md#ir.index.Corpus)

### ir.build_corpus(name, \*\*kwargs)

Build (or update) a registered/preset corpus by *name*; returns a [`Corpus`](ir.index.md#ir.index.Corpus).
...
* **Parameters:**
  ...
  * **expand** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`SearchHit`](ir.base.md#ir.base.SearchHit), [`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`Record`](ir.base.md#ir.base.Record)]], [`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`Record`](ir.base.md#ir.base.Record)]]]) – a `NeighborhoodPolicy` to also stitch each
  ...
  * **corpus** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – where `expand` finds each hit’s stored siblings — a
    [`Corpus`](ir.index.md#ir.index.Corpus) / [`CorpusStore`](ir.store.md#ir.store.CorpusStore) / name,
...
* **Parameters:**
  * **corpus** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – a built [`Corpus`](ir.index.md#ir.index.Corpus), or a registered corpus
  ...
  * **mode** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str)) – ranking mode — `"hybrid"` (default; `ir`’s strongest overall),
    `"dense"`, or `"lexical"`.
  * **strategy** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`SearchHit`](ir.base.md#ir.base.SearchHit)]], [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`SearchHit`](ir.base.md#ir.base.SearchHit)]]]) – selection strategy (see [`select()`](#ir.select)).
  ...
  * **filter** ([`Mapping`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Mapping)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)] | [`None`](https://docs.python.org/3/builtins/constants.html#None)) – retrieval constraints (forwarded to
    [`ir.retrieve.search()`](ir.retrieve.md#ir.retrieve.search)).
  ...
  * **max_k** ([`int`](https://docs.python.org/3/builtins/functions.html#int)) – selection parameters (see
    ...
    this `(corpus, mode)` by [`ir.eval.calibrate_min_score()`](ir.eval.md#ir.eval.calibrate_min_score) and
  ...
  * **merge** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)]) – federated only — how the per-source rankings combine: `"rrf"`
    ...
    [`ir.retrieve.fuse_hits()`](ir.retrieve.md#ir.retrieve.fuse_hits)), `"score"` (raw-score merge,
  ...
  * **merge_rrf_k** ([`int`](https://docs.python.org/3/builtins/functions.html#int) | [`None`](https://docs.python.org/3/builtins/constants.html#None)) – federated only — the cross-source RRF rank constant
    (default: [`DFLT_RRF_K`](ir.retrieve.md#ir.retrieve.DFLT_RRF_K); distinct from the
  ...
  * **expand** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`SearchHit`](ir.base.md#ir.base.SearchHit), [`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`Record`](ir.base.md#ir.base.Record)]], [`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`Record`](ir.base.md#ir.base.Record)]]]) – a `NeighborhoodPolicy` — also stitch each
  ...
  * **\*\*search_kw** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – any other [`ir.retrieve.search()`](ir.retrieve.md#ir.retrieve.search) keyword (`rrf_k`,
    `rerank`, `bm25`, …).
* **Return type:**
...
([`ir.retrieve.records_for_artifact()`](ir.retrieve.md#ir.retrieve.records_for_artifact)), asks *policy* which to keep,
...
* **Parameters:**
  * **hit** ([`SearchHit`](ir.base.md#ir.base.SearchHit)) – the seed [`SearchHit`](ir.base.md#ir.base.SearchHit) (its identity and score pass
    through to the [`Passage`](#ir.Passage) untouched).
  * **corpus** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – a [`Corpus`](ir.index.md#ir.index.Corpus), [`CorpusStore`](ir.store.md#ir.store.CorpusStore),
    or corpus name — whatever [`records_for_artifact()`](ir.retrieve.md#ir.retrieve.records_for_artifact)
    accepts. Must be the corpus the hit came from.
  * **policy** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`SearchHit`](ir.base.md#ir.base.SearchHit), [`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`Record`](ir.base.md#ir.base.Record)]], [`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`Record`](ir.base.md#ir.base.Record)]]]) – which siblings make up the neighborhood (default: sentence
...
* **Raises:**
  * [**KeyError**](https://docs.python.org/3/builtins/exceptions.html#KeyError) – the corpus has no ledger entry for the hit’s artifact
        ([`ir.retrieve.NoLedgerEntry`](ir.retrieve.md#ir.retrieve.NoLedgerEntry)), or the ledger is stale —
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`SearchHit`](ir.base.md#ir.base.SearchHit)]
* **Returns:**
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`MaintenanceResult`](ir.maintenance.md#ir.maintenance.MaintenanceResult)]
...
* **Return type:**
  [`MaintenanceResult`](ir.maintenance.md#ir.maintenance.MaintenanceResult)
...
An LLM-backed `Synthesizer` ([`Artifact`](ir.base.md#ir.base.Artifact) → synopsis).
...
The effective [`ir.policy.MaintenancePolicy`](ir.policy.md#ir.policy.MaintenancePolicy) for corpus *name*.

Resolves the registered entry’s `maintenance` over its kind’s smart default
over the global default (see [`ir.policy.resolve_policy()`](ir.policy.md#ir.policy.resolve_policy)). An unregistered
...
a [`SearchHit`](ir.base.md#ir.base.SearchHit) names its artifact (and, via
...
[`ir.base.Record.make_id()`](ir.base.md#ir.base.Record.make_id)), so derivation would fetch wrong or missing
siblings.

* **Parameters:**
  * **store_or_corpus** – a [`CorpusStore`](ir.store.md#ir.store.CorpusStore), anything carrying
    one as `.store` (e.g. a [`Corpus`](ir.index.md#ir.index.Corpus)), or a corpus
...
* **Raises:**
  * [**NoLedgerEntry**](ir.retrieve.md#ir.retrieve.NoLedgerEntry) – the ledger has no entry for *artifact_id* (an unknown
        artifact, or a corpus built without [`ir.index.build()`](ir.index.md#ir.index.build)’s
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`Record`](ir.base.md#ir.base.Record)]
...
[`ir.policy`](ir.policy.md#module-ir.policy)):

- `strategy` — an [`IndexingStrategy`](ir.strategy.md#ir.strategy.IndexingStrategy) (or a
...
- `maintenance` — the background-work policy dict (`reindex` / `synopsis`;
  validated here, see [`ir.policy.MaintenancePolicy`](ir.policy.md#ir.policy.MaintenancePolicy)).
...
* **Return type:**
  [`CoverageReport`](ir.coverage.md#ir.coverage.CoverageReport)
...
A [`Retriever`](ir.retrieve.md#ir.retrieve.Retriever) bound to the registered corpus *name*.
...
ready-to-call [`Retriever`](ir.retrieve.md#ir.retrieve.Retriever). This is the source-registry
...
Search a [`Corpus`](ir.index.md#ir.index.Corpus) (or a corpus *name*, reopened lazily).

Thin facade over [`ir.retrieve.search()`](ir.retrieve.md#ir.retrieve.search); `**kwargs` are forwarded to
...
(collapse to the best surface per artifact). See [`ir.retrieve.search()`](ir.retrieve.md#ir.retrieve.search)
...
* **Parameters:**
  * **hits** ([`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`SearchHit`](ir.base.md#ir.base.SearchHit)]) – ranked [`SearchHit`](ir.base.md#ir.base.SearchHit)s (best first), as returned by
    [`ir.retrieve.search()`](ir.retrieve.md#ir.retrieve.search).
  * **strategy** (`Union`[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`SearchHit`](ir.base.md#ir.base.SearchHit)]], [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`SearchHit`](ir.base.md#ir.base.SearchHit)]]]) – `"conservative"` (the default distractor-robust commit),
...
* **Parameters:**
  * **query** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str)) – the user intent.
  * **store** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – passed to *policy* verbatim — a [`Corpus`](ir.index.md#ir.index.Corpus) for
    [`collapsed_tree_policy()`](#ir.collapsed_tree_policy), a [`CorpusGraph`](ir.graph.md#ir.graph.CorpusGraph) for
...
* **Returns:**
  ...
  [`SearchHit`](ir.base.md#ir.base.SearchHit) with `metadata["walk_depth"]` / `["seed"]`.
...
| [`base`](ir.base.md#module-ir.base)               | Core data model for `ir`.                                                                                              |
|------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|
| [`cli`](ir.cli.md#module-ir.cli)                 | Command-line surface for `ir` (dispatched by cw).                                                                      |
| [`config`](ir.config.md#module-ir.config)           | Filesystem locations and process-wide defaults for `ir`.                                                               |
| [`coverage`](ir.coverage.md#module-ir.coverage)       | Corpus-coverage diagnostic — what's on disk vs. what's actually indexed.                                               |
| [`embed`](ir.embed.md#module-ir.embed)             | Embedder resolution for `ir` — a decent local default, a light fallback.                                               |
| [`eval`](ir.eval.md#module-ir.eval)               | Capability-discovery evaluation — measuring how well a corpus is *found*.                                              |
| [`eval_gen`](ir.eval_gen.md#module-ir.eval_gen)       | LLM-backed generation of evaluation cases for [`ir.eval`](ir.eval.md#module-ir.eval). |
| [`formulate`](ir.formulate.md#module-ir.formulate)     | Query formulation — the Formulator seam (ir_09 §3).                                                                    |
| [`graph`](ir.graph.md#module-ir.graph)             | The semantic link graph — typed edges between artifacts (report 12).                                                   |
| [`index`](ir.index.md#module-ir.index)             | The indexing pipeline and incremental maintenance.                                                                     |
| [`maintenance`](ir.maintenance.md#module-ir.maintenance) | Idempotent background-work runner — `ir maintain` (issue #58).                                                         |
| [`policy`](ir.policy.md#module-ir.policy)           | Per-corpus policy — how a corpus is segmented/stored and what background work it gets.                                 |
| [`registry`](ir.registry.md#module-ir.registry)       | Named-corpus registry — persistent, reusable corpus definitions.                                                       |
| [`retrieve`](ir.retrieve.md#module-ir.retrieve)       | Retrieval — hard metadata filtering + dense / lexical / hybrid ranking.                                                |
| [`schedule`](ir.schedule.md#module-ir.schedule)       | Install and operate the OS job that runs `ir maintain` — `ir schedule` (issue #75).                                    |
| [`sources`](ir.sources.md#module-ir.sources)         | Defining a corpus source — an abstract strategy plus parameters.                                                       |
| [`store`](ir.store.md#module-ir.store)             | Persistence for `ir` — the repository layer over `dol` key-value views.                                                |
| [`strategy`](ir.strategy.md#module-ir.strategy)       | Indexing strategies — the "what do we index?" seam.                                                                    |
| [`synopsis`](ir.synopsis.md#module-ir.synopsis)       | Synopsis surfaces — LLM-derived summaries as an indexed surface (report 12).                                           |
| [`tools`](ir.tools.md#module-ir.tools)             | Agent-callable tool surface over `ir` — plain functions returning JSON-ready dicts, deliberately MCP/HTTP-agnostic.    |
