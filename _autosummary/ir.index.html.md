...
[`build()`](#ir.index.build) turns a [`CorpusSource`](ir.sources.html.md#ir.sources.CorpusSource) into a queryable
[`Corpus`](#ir.index.Corpus), persisting records through a
[`CorpusStore`](ir.store.html.md#ir.store.CorpusStore). It is **incremental and idempotent**: each
...
* **Parameters:**
  ...
  * **edge_extractor** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)]) – (`(artifact_id, filter_fields) -> {edge_type: [target]}`) that
    ...
    pass [`ir.default_edge_extractor()`](ir.html.md#ir.default_edge_extractor) for the latent deps/parent
