...
[`IndexPlan`](ir.base.md#ir.base.IndexPlan): the `filter_fields` (hard-filterable metadata,
*not* embedded) and a list of [`Surface`](ir.base.md#ir.base.Surface) (embeddable units). This
...
[`ir.with_synopsis()`](ir.md#ir.with_synopsis) wrapper), is **not** captured here — those are set
...
reused by the shipped strategies *and* by [`ir.synopsis.make_llm_synthesizer()`](ir.synopsis.md#ir.synopsis.make_llm_synthesizer)
