...
LLM-backed generation of evaluation cases for [`ir.eval`](ir.eval.md#module-ir.eval).

This is the **build-time** companion to the offline scoring harness: it turns a
corpus into a set of [`DiscoveryCase`](ir.eval.md#ir.eval.DiscoveryCase)s by *back-translation* —
...
The output is plain [`DiscoveryCase`](ir.eval.md#ir.eval.DiscoveryCase) data — freeze it with
[`ir.eval.save_cases()`](ir.eval.md#ir.eval.save_cases) (stamping [`corpus_signature()`](#ir.eval_gen.corpus_signature) into the
`__meta__` header) and score it with [`ir.eval`](ir.eval.md#module-ir.eval). Generation needs a model;
scoring never does.
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`DiscoveryCase`](ir.eval.md#ir.eval.DiscoveryCase)]
...
* **Parameters:**
  * **source** ([`Any`](https://docs.python.org/3/library/typing.html#typing.Any)) – a [`CorpusSource`](ir.sources.md#ir.sources.CorpusSource) (anything with `.items()`).
