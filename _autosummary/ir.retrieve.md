...
[`ir.discover()`](ir.md#ir.discover) and by an orchestration layer’s fan-in reranker (ir_09 §3).
...
| [`Identity`](#ir.retrieve.Identity)         | `None` (default — hits from different sources never merge; same id, different corpus = different artifact), the string `"pointer"` (merge hits whose [`pointer`](ir.base.md#ir.base.SearchHit.pointer) match — opt-in, for corpora that genuinely index the same files), or any `hit -> hashable` callable (a falsy key falls back to per-source identity). |
...
| [`search`](#ir.retrieve.search)(corpus, query, \*[, k, filter, ...])         | Return the top-*k* [`SearchHit`](ir.base.md#ir.base.SearchHit) for *query*. |
...
[`pointer`](ir.base.md#ir.base.SearchHit.pointer) match — opt-in, for corpora that
...
alias of `Callable`[[[`SearchHit`](ir.base.md#ir.base.SearchHit)], [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)] | [`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`None`](https://docs.python.org/3/builtins/constants.html#None)
...
default). A corpus *name* is resolved once via [`ir.open_corpus()`](ir.md#ir.open_corpus); pass
...
* **Parameters:**
  ...
  * **weights** ([`Mapping`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Mapping)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`float`](https://docs.python.org/3/builtins/functions.html#float)] | [`None`](https://docs.python.org/3/builtins/constants.html#None)) – optional per-source trust dial (default 1.0 each) — a
    ...
    upfront, as federated [`ir.discover()`](ir.md#ir.discover) does.
...
* **Parameters:**
  * **store_or_corpus** – a [`CorpusStore`](ir.store.md#ir.store.CorpusStore), anything carrying
    ...
    *name* — resolved straight to its local store: sibling lookup
    never embeds, so unlike [`ir.open_corpus()`](ir.md#ir.open_corpus) no embedder is
    loaded.
...
Return the top-*k* [`SearchHit`](ir.base.md#ir.base.SearchHit) for *query*.
...
* **Parameters:**
  ...
  * **formulate** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str)], [`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`Sequence`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str)]]]) – [str, …]\`\`) applied *before* retrieval — rewrite / expand / HyDE
    ...
    per artifact). See [`ir.make_llm_formulator()`](ir.md#ir.make_llm_formulator).
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`SearchHit`](ir.base.md#ir.base.SearchHit)]
