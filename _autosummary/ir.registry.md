...
Presets map to [`CorpusSource`](ir.sources.md#ir.sources.CorpusSource) constructors:
...
|--------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|
| [`policy_for`](#ir.registry.policy_for)(name)                          | The effective [`ir.policy.MaintenancePolicy`](ir.policy.md#ir.policy.MaintenancePolicy) for corpus *name*. |
...
| [`retriever_for`](#ir.registry.retriever_for)(name, \*\*search_defaults)  | A [`Retriever`](ir.retrieve.md#ir.retrieve.Retriever) bound to the registered corpus *name*.                 |
...
[`ir.as_retriever()`](ir.md#ir.as_retriever); `search_defaults` (e.g. `mode="hybrid"`) bind to
every call.
